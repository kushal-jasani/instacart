...
const deliveryOrderSchema = Joi.object({
    ...
    gift_card_image_id: Joi.when('gift_option', {
      is: true, then: Joi.number().integer().required(), otherwise: Joi.number().integer().optional()
    }),
...
module.exports={deliveryOrderSchema,pickupOrderSchema,calculateSubTotalSchema,addressSchema}